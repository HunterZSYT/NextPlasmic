...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: oekjHB3KQwN8/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iIyNz)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___6ImTz)}>
            <div
              className={classNames(
                projectcss.all,
