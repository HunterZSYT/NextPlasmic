...
import MenuPopover from "../../MenuPopover"; // plasmic-import: YnlNJ6q5Gn7T/component
import MenuItem from "../../MenuItem"; // plasmic-import: oekjHB3KQwN8/component
import MenuSection from "../../MenuSection"; // plasmic-import: 4mMB9_CF7CFe/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: S6Vn7za983mt/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mJ0RO)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox___17Cwe)}>
            <ChevronDownIcon
