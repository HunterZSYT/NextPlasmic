...
import sty from "./PlasmicModal.module.css"; // plasmic-import: R1RzLBr6Q1vF/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_LdNBtteYctUU"]]: true })}
        ...
        >
          ...
          >
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__vItkW)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__lwDov)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
