...
import SliderThumb from "../../SliderThumb"; // plasmic-import: IkBFaqScew3A/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: OxaS62J1KAJJ/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ebyO)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ywW6R)}>
        <div
