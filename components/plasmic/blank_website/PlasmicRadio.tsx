...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: BJ-aTkIClJde/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__nvI10)}>
        <div className={classNames(projectcss.all, sty.freeBox__ymGzG)} />
      </div>
      {renderPlasmicSlot({
