...
import Label from "../../Label"; // plasmic-import: hZiGVo054IMp/component
import TextInput from "../../TextInput"; // plasmic-import: UQnrefBRWST0/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Rb0C1cH4lesP/component
import Description from "../../Description"; // plasmic-import: hCXjPSiuuu1v/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: J2iSB1Ih2aw4/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__nhlI4, {
          [sty.freeBoxiconEnd__nhlI4Joe5E]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__nhlI4CByhs]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__nhlI4Ufo05]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___6IJd9, {
            [sty.freeBoxiconStart___6IJd9CByhs]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___6IJd9Ufo05]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8SaD3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vgHyA, {
            [sty.freeBoxiconEnd__vgHyAjoe5E]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__vgHyAcByhs]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__kXorX)}
                role={"img"}
              />
            ),
