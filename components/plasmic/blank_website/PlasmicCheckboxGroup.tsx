...
import Checkbox from "../../Checkbox"; // plasmic-import: d_TSYz-qRq31/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 0gKAqfnzRmUd/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__uKtZx)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__bLqOt)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__cQtDk)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___4QYhy)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
