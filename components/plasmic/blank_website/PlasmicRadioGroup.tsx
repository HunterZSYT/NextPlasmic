...
import Radio from "../../Radio"; // plasmic-import: BJ-aTkIClJde/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: zDzuzmY15N7W/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__q6OCy)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__wVcAg)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__vxA6I)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__kLz0X)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
