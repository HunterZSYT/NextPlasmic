...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: wkqmsrD_M7Vs/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: TV0tiWaDOaFs/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox___11F8Z)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__zl5D7)}
            label={"Open Popover"}
          />
        ),
