...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: d_TSYz-qRq31/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: yESdzM284HDv/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: mj9KXQPqfAAJ/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__miVb9)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__roee)}
            role={"img"}
          />
        ) : null}
      </div>
